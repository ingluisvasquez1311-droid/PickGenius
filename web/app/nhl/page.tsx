...
export default function NHLPage() {
    const { data: allEvents = [], isLoading: loading, error } = useSportsEvents('nhl');
    ...
    return (
        <main className="min-h-screen pb-20 bg-[#050505] text-white selection:bg-blue-500/30">
            <SportHeader
                title="NHL HOCKEY"
                sport="ICE-HOCKEY"
                emoji="🏒"
                color="from-blue-900/40 to-black"
                accentColor="bg-blue-500/5 blur-[120px]"
                subtitle="Ice Insights • Power Play Coverage • Puck AI"
            />
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div className="glass-card p-6 border border-white/5 bg-white/2 rounded-3xl">
                                ...
                                <div className="text-4xl font-black text-blue-500 tracking-tighter">75%</div>
                            </div>
                            <div className="glass-card p-6 border border-white/5 bg-white/2 rounded-3xl">
                                <div className="text-[10px] font-black uppercase text-gray-500 mb-1">Goles Promedio</div>
                                <div className="text-4xl font-black tracking-tighter">5.8</div>
                            </div>
                        </div>
                                ...
                                {filter === 'all' ? (
                                    <>
                                        ...
                                        {filteredEvents.length === 0 && (
                                            <div className="glass-card p-32 text-center border-dashed border-2 border-white/5 rounded-[4rem] bg-white/[0.01]">
                                                ...
                                                <p className="text-gray-500 font-black uppercase tracking-[0.2em] text-sm">No hay actividad sobre hielo</p>
                                    ...
                                    <>
                                        <div className="flex items-center justify-between mb-8 px-2">
                                            <h2 className="text-2xl font-black italic tracking-tighter uppercase flex items-center gap-3">
                                                <span className={`w-3 h-8 rounded-full ${filter === 'live' ? 'bg-red-500' : 'bg-blue-600'}`}></span>
