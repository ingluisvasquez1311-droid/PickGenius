...
export async function GET(request: NextRequest) {
    ...
    try {
        console.log(`🚀 [TEST MODE] Fetching football scheduled for ${date} DIRECTLY from SofaScore`);

        const directUrl = `${SOFASCORE_API}/sport/football/scheduled-events/${date}`;
