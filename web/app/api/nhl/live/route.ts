...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        try {
            // Nota: SofaScore usa 'hockey' para hockey sobre hielo
            const directUrl = `${SOFASCORE_API}/sport/hockey/events/live`;
        ...
        const firebaseEvents = await firebaseReadService.getLiveGames(SPORT);
