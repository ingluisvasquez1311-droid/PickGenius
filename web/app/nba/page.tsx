                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-orange-400">Hardwood Tactical Analysis</span>
                            </div>
                            <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">
                                NBA <span className="text-orange-500">SUPREME ELITE</span>
                            </h1>
                            <p className="text-gray-400 font-mono text-xs tracking-[0.4em] uppercase mt-2">Dunk Insights • Court Vision • Point Guard AI</p>
                        </div>
                    </div>
                </div>
            </div>
