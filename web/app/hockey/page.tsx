    ...
    return (
        <div className="min-h-screen bg-[#020202] text-white pt-24 pb-20 px-4 md:px-12 max-w-[1600px] mx-auto relative overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none opacity-20">
                ...
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-sky-600/10 blur-[250px] -translate-y-1/2 translate-x-1/2 rounded-full"></div>
            </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 border-b-2 border-white/10 pb-12">
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            <Link href="/" className="group p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-sky-600 transition-all duration-500">
                                <ArrowLeft className="w-6 h-6 text-gray-400 group-hover:text-white" />
                            </Link>
                            <span className="text-[10px] font-black uppercase tracking-[0.8em] text-sky-400 bg-sky-400/10 px-4 py-1.5 rounded-full border border-sky-400/20">
                                Cold Data Engine
                            </span>
                        </div>
                        <h1 className="text-7xl md:text-9xl font-black italic tracking-tighter uppercase leading-[0.8] flex flex-col">
                            <span className="text-white">HUB</span>
                            <span className="text-transparent" style={{ WebkitTextStroke: '2px rgba(255,255,255,0.2)' }}>NHL ICE</span>
                        </h1>
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-1 bg-sky-600"></div>
                            <p className="text-gray-500 font-bold uppercase tracking-[0.3em] text-[10px]">Analítica de Impacto y Power Play v2.1</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-6 w-full lg:w-auto">
                        <div className="flex flex-wrap gap-4">
                            ...
                            <div className="flex bg-white/[0.02] border-2 border-white/10 p-1.5 rounded-[1.5rem] shadow-inner">
                                ...
                                >
                                    ...
                                    Live {hockeyLiveCount > 0 && (
                                        <span className="ml-1.5 px-2 py-0.5 bg-white/20 rounded-md text-[9px]">{hockeyLiveCount}</span>
                                    )}
                                </button>
                                <button
                                    ...
                                    className={clsx(
                                        "px-8 py-3 rounded-xl font-black uppercase tracking-widest text-[11px] flex items-center gap-3 transition-all duration-500",
                                        activeFilter === 'scheduled' ? "bg-sky-600 text-white shadow-[0_0_25px_rgba(2,132,199,0.4)]" : "text-gray-600 hover:text-white"
                                    )}
                                >
                            ...
                            <Link href="/props?sport=hockey" className="group flex items-center gap-4 px-8 py-4 bg-white/5 hover:bg-white/10 border-2 border-white/5 rounded-2xl transition-all duration-500">
