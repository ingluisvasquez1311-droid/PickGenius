...
export default function TopLeadersWidget() {
    ...
    return (
        <div className="bg-[#0a0a0a]/60 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm">
            {/* Header */}
            <div
                className="bg-gradient-to-r from-primary/10 to-blue-600/10 p-4 cursor-pointer flex items-center justify-between border-b border-white/5"
                                                        ...
                                                        {topPlayers.slice(0, 5).map((player) => (
                                                            <div key={player.player.id} className="flex items-center gap-2 p-2 bg-white/[0.03] rounded-lg hover:bg-white/[0.06] transition-colors">
                                                                ...
                                                                <div className="text-right flex-shrink-0">
                                                                    <p className="text-sm font-black text-primary">{player.statisticsValue}</p>
                                                                </div>
                                                            </div>
                                                        ))}
                                                    </div>
