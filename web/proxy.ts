...
export function proxy(request: NextRequest) {
    ...
    if (path.startsWith('/api/')) {
        ...
        // Headers CORS permisivos para desarrollo (Sincronizado de middleware.ts)
        ...
        response.headers.set('X-Frame-Options', 'SAMEORIGIN'); // Ajustado para ser menos restrictivo que DENY si es necesario en dev
